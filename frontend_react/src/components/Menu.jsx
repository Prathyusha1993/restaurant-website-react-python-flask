                          ...
                          >
                            ...
                            <Modal show={showOrderModal} backdrop="true" className="modal-backdrop.show" onHide={() => setShowOrderModal(false)} centered > 
                              ...
                              <Modal.Body className='text-center'>
                                <Button 
                                variant="outline-primary"
                                style={{outline:'none', boxShadow:'none', border:'none', padding:0, backgroundColor:'transparent'}}
                                className="m-2"
                                href="https://www.zomato.com/bangalore/aha-biriyani-btm-bangalore/order"
                                target="_blank">
                                  <SiZomato size={70}  style={{backgroundColor:'red', color:'white', borderRadius:'10px', padding:'5px'}} />
                                </Button>
